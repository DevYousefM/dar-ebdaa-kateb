...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">قائمة الكتب</h3>
		<div class="card-tools">
			<a href="?page=product/manage_product" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> اضافه كتاب جديد</a>
		</div>
	</div>
	<div class="card-body">
							...
							<tr>
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item" href="?page=product/manage_product&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> تعديل</a>
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("هل أنت متاكد ن حذف هذا الكتاب ؟", "delete_product", [$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
