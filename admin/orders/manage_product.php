...
<div class="card card-outline card-info">
    ...
    <div class="card-body">
        <form action="" id="product-form">
            ...
            <div class="form-group">
                <label for="sub_category_id" class="control-label">التصنيف الفرعي</label>
                <select name="sub_category_id" id="sub_category_id" class="custom-select" required>
                    <option value="" selected="" disabled="">اختر التصنيف الأول</option>
                    <?php
            ...
            <div class="form-group">
                <label for="product_name" class="control-label">اسم الكتاب</label>
...
<script>
    ...
    $(document).ready(function() {
        $('.rem_img').click(function() {
            _conf("هل أنت متاكد من حذف هذا الكتاب؟", 'delete_img', ["'" + $(this).attr('data-path') + "'"])
        })
