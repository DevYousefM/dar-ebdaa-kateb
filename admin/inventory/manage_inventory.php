...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update " : "Create New " ?> قائمة الجرد</h3>
	</div>
	<div class="card-body">
		<form action="" id="inventory-form">
			<input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="product_id" class="control-label">الكتاب</label>
			...
			<div class="form-group">
				<label for="quantity" class="control-label">بداية الكمية</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="inventory-form">حفظ</button>
		<a class="btn btn-flat btn-default" href="?page=inventory">الغاء</a>
	</div>
</div>
<script>
