...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">قائمة الجرد</h3>
		<div class="card-tools">
			<a href="?page=inventory/manage_inventory" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> انشاء قائمة جرد جديده</a>
		</div>
	</div>
	<div class="card-body">
					...
					<tbody>
						...
						?>
							<tr>
								...
								<td>
									<p class="m-0"><small><b>:العنوان</b> <?php echo $row['product'] ?></small></p>
									<p class="m-0 truncate"><b>:الكاتب</b> <?php echo $row['author'] ?></p>
								</td>
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item" href="?page=inventory/manage_inventory&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> تعديل</a>
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("هل أنت متأكد من حذف هذا الجرد؟", "delete_inventory", [$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
