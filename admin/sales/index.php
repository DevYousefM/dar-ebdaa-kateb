    ...
    <div class="card-body">
        <form id="filter-form">
            <div class="row align-items-end">
                ...
                <div class="form-group col-md-3">
                    <label for="date_start">تاريخ الأنتهاء</label>
                    <input type="date" class="form-control form-control-sm" name="date_end" value="<?php echo date("Y-m-d", strtotime($date_end)) ?>">
                </div>
                <div class="form-group col-md-1">
                    <button class="btn btn-flat btn-block btn-primary btn-sm"><i class="fa fa-filter"></i> تصنيف</button>
                </div>
                <div class="form-group col-md-1">
                    <button class="btn btn-flat btn-block btn-success btn-sm" type="button" id="printBTN"><i class="fa fa-print"></i> طباعة</button>
                </div>
            </div>
        </form>
        <hr>
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>تقرير المبيعاتt</b></h3>
                <p class="text-center m-0">التاريخ بين <?php echo $date_start ?> و <?php echo $date_end ?></p>
                <hr>
            </div>
                    ...
                    ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="m-0"><small>:الكاتب <?php echo $roww['author'] ?></small></p>
                                </td>
                                <td>
                                    <p class="m-0"><?php echo $roww['name'] ?></p>
                                    <p class="m-0"><small>:الميل <?php echo $roww['email'] ?></small></p>
                                </td>
