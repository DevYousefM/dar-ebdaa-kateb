...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update " : "Create New " ?> التصنيفات الفرعية</h3>
	</div>
	<div class="card-body">
		<form action="" id="category-form">
			<input type="hidden" name="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="parent_id" class="control-label">التصنيف </label>
			...
			<div class="form-group">
				<label for="sub_category" class="control-label">اسم التصنيف الفرعي</label>
	...
	<div class="card-footer">
		<button class="btn btn-flat btn-primary" form="category-form">حفظ</button>
		<a class="btn btn-flat btn-default" href="?page=maintenance/sub_category">الغاء</a>
	</div>
</div>
<script>
