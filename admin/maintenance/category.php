...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=maintenance/manage_category" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> انشاء تصنيف جديد</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("هل أنت متأكد من حذف هذا التصنيف؟", "delete_category", [$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
