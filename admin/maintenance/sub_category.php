...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=maintenance/manage_sub_category" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span> انشاء تصنيف فرعي جديد</a>
		</div>
	</div>
	<div class="card-body">
							...
							<tr>
								...
								<td align="center">
									...
									<div class="dropdown-menu" role="menu">
										<a class="dropdown-item" href="?page=maintenance/manage_sub_category&id=<?php echo $row['id'] ?>"><span class="fa fa-edit text-primary"></span> تعديل</a>
...
<script>
	$(document).ready(function() {
		$('.delete_data').click(function() {
			_conf("هل أنت متاكد من حذف هذا التصنيف الفرعي؟", "delete_category", [$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
