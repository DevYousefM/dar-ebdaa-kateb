		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">اسم الضفحة</label>
					<input type="text" class="form-control form-control-sm" name="name" id="name" value="<?php echo $_settings->info('name') ?>">
				</div>
				<div class="form-group">
					<label for="short_name" class="control-label">الاسم المختصر للصفحة</label>
					<input type="text" class="form-control form-control-sm" name="short_name" id="short_name" value="<?php echo  $_settings->info('short_name') ?>">
				</div>
				<div class="form-group">
					<label for="" class="control-label">معلومات عنا</label>
				...
				<div class="form-group">
					<label for="" class="control-label">سياسة الخصوصية</label>
				...
				<div class="form-group">
					<label for="" class="control-label">شعار الصفحة</label>
				...
				<div class="form-group">
					<label for="" class="control-label">غلاف الصفحة</label>
					<div class="custom-file">
