        ...
        <div class="card rounded-0">
            <div class="card-body">
                <div class="w-100 justify-content-between d-flex">
                    <h4><b>تحديث تفاصيل الحساب</b></h4>
                    <a href="./?p=my_account" class="btn btn btn-dark btn-flat">
                        <div class="fa fa-angle-left"></div> العودة إلى قائمة الطلب
                    </a>
                </div>
                ...
                <div class="col-md-6">
                    <form action="" id="update_account">
                        ...
                        <div class="form-group">
                            <label for="lastname" class="control-label">اسم العائلة</label>
                        ...
                        <div class="form-group">
                            ...
                            <select name="gender" id="" class="custom-select select" required>
                                <option <?php echo $_settings->userdata('gender') == "Male" ? "selected" : '' ?>>ذكر</option>
                                <option <?php echo $_settings->userdata('gender') == "Female" ? "selected" : '' ?>>أنثي</option>
                            </select>
                        </div>
                        <div class="form-group">
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (typeof resp == 'object' && resp.status == 'success') {
                        alert_toast("تم تحديث الحساب بنجاح", 'success');
                        $('#update_account [name="password"],#update_account [name="cpassword"]').attr('required', false);
