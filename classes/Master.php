...
class Master extends DBConnection
{
	...
	function save_category()
	{
		...
		if ($save) {
			$resp['status'] = 'success';
			if (empty($id))
				$this->settings->set_flashdata('success', "ت تسجيل تصنيف جديد بنجاح");
			else
				$this->settings->set_flashdata('success', "تم تحديث التصنيف بنجاح");
		} else {
			$resp['status'] = 'failed';
	...
	function delete_category()
	{
		...
		if ($del) {
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success', "تم حذف التصنيف بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_sub_category()
	{
		...
		if ($save) {
			$resp['status'] = 'success';
			if (empty($id))
				$this->settings->set_flashdata('success', "تم تسجيل تصنيف فرعي بنجاح");
			else
				$this->settings->set_flashdata('success', "تم تحديث تصنيف فرعي بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error . "[{$sql}]";
		}
	...
	function delete_sub_category()
	{
		...
		if ($del) {
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success', "تم حذف تصنيف فرعي بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_product()
	{
		...
		if ($save) {
			...
			$resp['status'] = 'success';
			if (empty($id))
				$this->settings->set_flashdata('success', "تم تسجيل الكتاب بنجاح");
			else
				$this->settings->set_flashdata('success', "تم تحديث الكتاب بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error . "[{$sql}]";
		}
	...
	function delete_product()
	{
		...
		if ($del) {
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success', "ت حذف الكتاب بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function save_inventory()
	{
		...
		if ($save) {
			$resp['status'] = 'success';
			if (empty($id))
				$this->settings->set_flashdata('success', "تم اضافه جرد جديد بنجاح");
			else
				$this->settings->set_flashdata('success', "تم تحديث جرد بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error . "[{$sql}]";
		}
	...
	function delete_inventory()
	{
		...
		if ($del) {
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success', "تم حذف الجرد بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['error'] = $this->conn->error;
		}
	...
	function register()
	{
		...
		if ($save) {
			$resp['status'] = 'success';
			if (empty($id))
				$this->settings->set_flashdata('success', "تم انشاء الحساب بنجاح");
			else
				$this->settings->set_flashdata('success', "تم تحديث الحساب بنجاح");
			foreach ($_POST as $k => $v) {
	...
	function delete_order()
	{
		...
		if ($delete) {
			$resp['status'] = 'success';
			$this->settings->set_flashdata('success', "تم حذف الاوردر بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error . "[{$sql}]";
		}
	...
	function update_order_status()
	{
		...
		if ($update) {
			$resp['status'] = 'success';
			$this->settings->set_flashdata("success", " تم تحديث حالة الاوردر بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error;
		}
	...
	function pay_order()
	{
		...
		if ($update) {
			$resp['status'] = 'success';
			$this->settings->set_flashdata("success", " ت تحديث حالة دفع الاوردر بنجاح");
		} else {
			$resp['status'] = 'failed';
			$resp['err'] = $this->conn->error;
		}
