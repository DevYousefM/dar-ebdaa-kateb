        ...
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <div class="fs-5 mb-5">
                    ...
                    <br>
                    <span><small><b>:الكمية المتبقية</b> <span id="avail"><?php echo $inv[0]['quantity'] ?></span></small></span>
                </div>
...
<section class="py-5 bg-light">
    <div class="container px-4 px-lg-5 mt-5">
        <h2 class="fw-bolder mb-4">كتب ذات صله</h2>
                        ...
                        <div class="card-body p-4">
                            <div class="">
                                ...
                                <?php foreach ($_inv as $k => $v) : ?>
                                    <span><b>:السعر </b><?php echo $v ?></span>
                                <?php endforeach; ?>
            ...
            $.ajax({
                ...
                success: function(resp) {
                    if (typeof resp == 'object' && resp.status == 'success') {
                        alert_toast("تم اضافة الكتاب للعربة بنجاح", 'success')
